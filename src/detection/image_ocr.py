...
Download from https://github.com/keras-team/keras/blob/master/examples/image_ocr.py
...
def paint_text(text, w, h, rotate=False, ud=False, multi_fonts=False):
    ...
    print("before speckle: ", type(a), a.shape)
    a = speckle(a)
...
def predict():
    ...
    weight_file = './weights24-pretrained.h5'
    img_w = 128
    # Input Parameters
    img_h = 64
    words_per_epoch = 16000
    ...
    pred_texts = predit_a_image(model_p, image)
    print(pred_texts)
...
if __name__ == '__main__':
    ...
    # run_name = "20190906-1"
    # train(run_name, 2, 5, 128)
    # # train(run_name, 5, 10, 128)
    # # train(run_name, 10, 15, 128)
    # # train(run_name, 15, 20, 128)
